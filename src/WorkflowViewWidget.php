<?php
namespace jinowom\workflow\view;
...
class WorkflowViewWidget extends Widget
{
    ...
    public function init()
    {
        ...
        if ( $this->workflow instanceof \yii\base\Model ) {
        	...
        	if ( ! \jinowom\workflow\base\SimpleWorkflowBehavior::isAttachedTo($this->workflow)) {
        ...
        } elseif ( $this->workflow instanceof \jinowom\workflow\base\WorkflowInterface ) {
